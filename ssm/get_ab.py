...
def load_mfd_catalog(
    ...
    *,
    ...
    if catalogs is None or labels is None:
        catalogs = [cat_paths.cat_intra_slab_dc, cat_paths.cat_slab_deep_dc]
        labels = ["intra_slab", "slab_deep"]
...
if __name__ == "__main__":
    ...
    mfd_df.to_csv("mfd_outputs/mfd_curve.csv", index=False)
    print("[__main__] Wrote mfd_outputs/mfd_curve.csv")

    plot_mfd(mfd_df, outdir=Path("mfd_outputs"), filename="mfd_cumulative.png")
