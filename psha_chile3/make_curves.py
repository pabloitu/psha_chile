...
model_with = hazard.hazardResults('Faults', './model_faults_sa', 1635)
model_with.parse_db(imtl)
model_with.get_stats('hcurves', 'SA(0.2)')
...
for city, coords in cities.items():
    ax = model_with.plot_pointcurves('SA(0.2)', point=coords, title=city,
