...
from crustal.s00_decluster import load
...
def main(c=None):
    ...
    for k in c.CLASSES:
        ...
        y0 = c.HIST_CUTOFF_BY_CLASS.get(k, c.HIST_CUTOFF) or c.DC_FROM_YEAR
        wins = mc.regular(y0, te, c.WINDOW_YEARS_BY_CLASS.get(k, c.WINDOW_YEARS), hist_from=int(s["year"].min()))
