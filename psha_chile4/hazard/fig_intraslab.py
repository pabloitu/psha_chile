...
# intraslab/check_rates.py. Outputs: outputs/hazard/_contrib/figures/
...
# settings
CONTRIB = paths.OUT / "hazard" / "_contrib"
SPLITS = [("all_classes", "reference"), ("all_cm_classes", "classmask")]
